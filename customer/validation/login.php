...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: /customer/p/account.php");
    exit;
}
 
// Include config file
require_once "/customer/scripts/config.php";
...
<?php include "/customer/assets/simple-header.php"?>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a href="/customer/validation/register.php">Sign up now</a>.</p>
        </form>
    </div>
</body>
</html>