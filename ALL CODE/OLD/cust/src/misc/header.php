...
<div class="navbar">
    ...
    <div class="subnav">
        ...
        <a href="./pages/borrow/my-borrowed-items.php">My Borrowed Items</a>
				<a href="./pages/borrow/borrow-an-item.php">Borrow an Item</a>
			</div>
		</div>
    ...
    <div class="subnav">
		  <button class="subnavbtn"><i class="fa-solid fa-wrench"></i> Repair <i class="fa fa-caret-down"></i></button>
			<div class="subnav-content">
				<a href="./pages/repair/my-repair-sessions.php">My Repair Sessions</a>
				<a href="./pages/repair/book-a-repair.php">Book a Repair Session</a>
		  </div>
		</div>
    ...
    <div class="subnav">
		  <button class="subnavbtn"><i class="fa-solid fa-chalkboard-user"></i> How To <i class="fa fa-caret-down"></i></button>
			<div class="subnav-content">
				<a href="./pages/howto/my-booked-howto.php">My Booked HowTos Sessions</a>
				<a href="./pages/howto/book-a-howto.php">Book a HowTo Session</a>
			</div>
		</div>
